...
const CardSliders = ({slide}) => {
  ...
  useEffect(() => {
      const slideInterval = setInterval(() => {setIndex(Index + 1)}, 2000);
...
const Cards4 = [
    {
        img: 'https://th.bing.com/th/id/OIP.Oy8NZaIxP6yfiywFOOzZkgHaIp?w=195&h=228&c=7&r=0&o=5&dpr=1.5&pid=1.7'
    },
    {
        img: 'https://th.bing.com/th/id/OIP.5_kxexdE1by1Y2nANpns_AHaJ2?w=163&h=216&c=7&r=0&o=5&dpr=1.5&pid=1.7'
    },
    {
        img: 'https://th.bing.com/th/id/OIP.EdOzMZzIIT0375jriZDP6gHaHa?w=216&h=216&c=7&r=0&o=5&dpr=1.5&pid=1.7'
    },
    {
        img: 'https://th.bing.com/th/id/OIP.xJbagif7NW5Is6WaEiLSggHaEj?w=287&h=180&c=7&r=0&o=5&dpr=1.5&pid=1.7'
    },
    {
        img: 'https://th.bing.com/th/id/OIP.XOhWEtEqdKP1lDgGi4c1wgHaLG?w=195&h=292&c=7&r=0&o=5&dpr=1.5&pid=1.7'
    },
]
